		...
		<div class="header-top">
			<div class="container"> 
				<div class="header-top-left">
					<ul>
						<li><span aria-hidden="true"></span>Welcome to your Tutor Panel
						<?php echo $db_field['TFName'];	?>
						</li>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
								  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cohort<span class="caret"></span></a>
								...
								<li><a href="mail.html">Forums</a></li>
